...
[scripts/launch_cluster.sh](../scripts/launch_cluster.sh) builds a per-node
...
The current code in [launch_cluster.sh:397-413](../scripts/launch_cluster.sh#L397-L413)
