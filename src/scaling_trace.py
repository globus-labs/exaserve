...
Usage (aurora_serve.py / driver.py):
    ...
    tracer.save("/tmp/aurora_scaling_trace.json")
"""
...
def trace_token() -> str:
    ...
    for candidate in (
        os.environ.get("AURORA_SCALING_TRACE_TOKEN", ""),
...
def trace_root_dir() -> str:
    ...
    return os.path.join("/tmp", f"aurora_scaling_trace_{trace_token()}")
...
class ScalingTracer:
    ...
    def __init__(self) -> None:
        ...
        self._enabled = os.environ.get("AURORA_SCALING_TRACE", "1") != "0"
