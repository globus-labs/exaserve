...
HTTP_PROXY_TIMEOUT = 3600  # Aurora: was 60; extended to survive head-node congestion at 256n+
...
DEFAULT_HEALTH_CHECK_PERIOD_S = 120  # Aurora: was 10
DEFAULT_HEALTH_CHECK_TIMEOUT_S = 600  # Aurora: was 30
...
PROXY_HEALTH_CHECK_TIMEOUT_S = get_env_float_positive(
    "RAY_SERVE_PROXY_HEALTH_CHECK_TIMEOUT_S", 300.0  # Aurora: was 10.0
)
...
PROXY_READY_CHECK_TIMEOUT_S = get_env_float_positive(
    "RAY_SERVE_PROXY_READY_CHECK_TIMEOUT_S", 60.0  # Aurora: was 5.0; metrics agent needs 30s
)

# Number of times in a row that a HTTP proxy must fail the health check before
# being marked unhealthy.
PROXY_HEALTH_CHECK_UNHEALTHY_THRESHOLD = 100  # Aurora: was 3
...
#: being marked unhealthy.
REPLICA_HEALTH_CHECK_UNHEALTHY_THRESHOLD = 100  # Aurora: was 3
