...
can either ``export EXASERVE_PROJECT_ACCOUNT=...`` once or pass values per
invocation.
...
Names:
    ...
    EXASERVE_DEFAULT_QUEUE         PBS queue name        (default: "debug-scaling")
    EXASERVE_DEFAULT_WALLTIME      PBS walltime hh:mm:ss (default: "01:00:00")
...
def get_site_defaults() -> SiteDefaults:
    ...
    return SiteDefaults(
        ...
        queue=os.environ.get("EXASERVE_DEFAULT_QUEUE", _DEFAULTS.queue),
        walltime=os.environ.get("EXASERVE_DEFAULT_WALLTIME", _DEFAULTS.walltime),
