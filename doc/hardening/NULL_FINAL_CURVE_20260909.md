...
halts the ladder; a retry needs diagnosis, new authorization and a fresh
identity. Failed bundles are never reset or resubmitted. Existing artifacts,
...
|---|---|---|---|---|
| run12/n32 | 8814592 | Submitted; canonical SUBMITTED, attempt 1 | pending | pending |
| run13/n32 | none | PLANNED; gated on accepted run12/n32 | pending | pending |
